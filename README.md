...
```js
function 함수명() {
  // return은 생략 가능, 그러나 기본으로 return undefined
}
함수명(); // 호출한다 Call
```
...
// 화살표 함수로 표현
const 변수명2: 내가만든타입 => void = (a: number): void => {};
```
