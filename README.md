...
- 문제상황 2
  ...
  - 그러나 여전히 `키명은 오타`를 내거나 `키명 변경` 시 적용 부분을 개선하지 못함
...
- 위의 코드 역시 상당히 문법적으로 복잡하고 가동성도 떨어짐
- 유틸리티를 이용해봄
...
```ts
// 원하는 속성의 이름과 타입을 추출했는데 옵셔널로 설정하고 싶을 때
/**
 * type UserGetApiAll4 = {
