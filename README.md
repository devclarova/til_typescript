...
type memberType = { 이름: string; 생일: string };

const 블랙핑크_멤버: memberType[] = [
  { 이름: "제니", 생일: "96-01" },
  { 이름: "로제", 생일: "97-02" },
  { 이름: "지수", 생일: "95-01" },
  { 이름: "리사", 생일: "97-03" },
...
// 아래는 참조로 접근하므로 변경이 가능함
// 아이유가 const이지, job은 const가 아님
아이유.job = "연기자"; // 됩니다.
...
## 8. 객체 구조 분해 할당(Destructuring) <!-- 중요! -->
